'''
All images processed and saved to 30kds_real_face_crop_mediapipe\Real
Total images processed: 100
Images cropped using face detection: 74 (74.0%)
Images cropped using central cropping: 26 (26.0%)
Face detection method used: MediaPipe
'''
...
OUTPUT_DIR = "30kds_real_face_crop_mediapipe"
...
# Function for face detection using MediaPipe
def detect_face(image, filename=""):
    ...
    with mp_face_detection.FaceDetection(min_detection_confidence=CONF_THRESHOLD) as face_detection:
    ...
    if DEBUG:
        ...
        for i, (x, y, w, h, conf) in enumerate(faces):
            print(f"  Face {i+1}: method=MediaPipe, confidence={conf:.3f}, coords=[{x}, {y}, {w}, {h}]")
...
print(f"Face detection method used: MediaPipe")
